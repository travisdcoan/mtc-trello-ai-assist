...
const BC = (window.BC_CONFIG || {});
const APP_KEY = BC.APP_KEY || (Array.isArray(BC.APP_KEYS) ? BC.APP_KEYS[0] : "");
const PU_BASE = BC.PU_BASE || "";
const V = BC.V || ""; // cache-buster for collaborators
const APP_NAME = BC.APP_NAME || "Verb-Starter Checker (Offline)";
const APP_AUTHOR = BC.APP_AUTHOR || "Trav Coan";

if (!APP_KEY || !PU_BASE) {
  console.warn("[BeCurrent] Missing BC_CONFIG (APP_KEY/PU_BASE). Did you load js/bc-config.js before js/main.js?");
}
